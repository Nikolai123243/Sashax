...
const animateElements = document.querySelectorAll('.fighter-card, .event-card, .stat-card, .gallery-item');
...
// Fighter rating stars interaction
document.querySelectorAll('.fighter-card').forEach(card => {
